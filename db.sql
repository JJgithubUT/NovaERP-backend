...
CREATE TABLE ventas.cotizacion (
  ...
  vigente_hasta  DATE,
  vendedor_id    UUID REFERENCES core.usuario(id),   -- RV-01..06: atribución comercial
  created_at     TIMESTAMPTZ NOT NULL DEFAULT now(),
  updated_at     TIMESTAMPTZ NOT NULL DEFAULT now(),
...
-- RV-01..06: índices de soporte de los reportes de ventas. Sin ellos, todo
-- agregado por rango de fechas hace seq scan (estas tablas no tenían ninguno
-- más allá de la PK y el unique de folio).
CREATE INDEX idx_factura_venta_tenant_fecha    ON ventas.factura_venta(tenant_id, fecha_emision);
CREATE INDEX idx_factura_venta_tenant_cliente  ON ventas.factura_venta(tenant_id, cliente_id);
CREATE INDEX idx_factura_venta_tenant_vendedor ON ventas.factura_venta(tenant_id, vendedor_id);
CREATE INDEX idx_cotizacion_tenant_estado      ON ventas.cotizacion(tenant_id, estado, created_at);
CREATE INDEX idx_pedido_tenant_estado          ON ventas.pedido_venta(tenant_id, estado, created_at);
...
-- RV-01..06: el ranking de productos recorre las líneas de las facturas del
-- rango; las notas de crédito se agregan por SU propia fecha (RN-02).
CREATE INDEX idx_factura_linea_factura     ON ventas.factura_linea(factura_id);
CREATE INDEX idx_nota_credito_tenant_fecha ON ventas.nota_credito(tenant_id, created_at);
...
-- RV-05: la cartera solo mira cuentas con saldo vivo; índice parcial.
CREATE INDEX idx_cxc_tenant_pendiente ON finanzas.cuenta_por_cobrar(tenant_id) WHERE saldo > 0;
...
-- ==========================================
-- INICIO DEL ARCHIVO: 2026-07-23_rf20_auditoria.sql
-- ==========================================
...
-- ==========================================
-- INICIO DEL ARCHIVO: 2026-07-24_rf06_usuario_puesto_departamento.sql
-- ==========================================
...
-- ==========================================
-- INICIO DEL ARCHIVO: 2026-07-24_rf07_usuario_telefono.sql
-- ==========================================
...
-- ==========================================
-- INICIO DEL ARCHIVO: 2026-07-24_rf08_login_mensaje_suspendido.sql
-- ==========================================
...
-- ==========================================
-- INICIO DEL ARCHIVO: 2026-07-24_rf10_rbac_catalogo.sql
-- ==========================================
...
-- ==========================================
-- INICIO DEL ARCHIVO: 2026-07-24_rf16_login_validador_puro.sql
-- ==========================================
...
-- ==========================================
-- INICIO DEL ARCHIVO: 2026-07-24_rf16_reset_mfa_permiso.sql
-- ==========================================
...
-- ==========================================
-- INICIO DEL ARCHIVO: 2026-07-25_rf01_04_tenants.sql
-- ==========================================
...
-- ==========================================
-- INICIO DEL ARCHIVO: 2026-07-25_rf30_44_ventas.sql
-- ==========================================
...
-- ==========================================
-- INICIO DEL ARCHIVO: 2026-07-25_sysadmin_sesion.sql
-- ==========================================
...
-- ==========================================
-- INICIO DEL ARCHIVO: 2026-08-03_rv01_06_reportes_ventas.sql
-- ==========================================
...
-- ==========================================
-- INICIO DEL ARCHIVO: 2026-08-14_rutas_publicas_reservadas.sql
-- ==========================================
